...
import static com.example.museic.MainActivity.ARTIST_TO_FRAG;
import static com.example.museic.MainActivity.PATH_TO_FRAG;
import static com.example.museic.MainActivity.SHOW_MINI_PLAYER;
import static com.example.museic.MainActivity.SONG_NAME_TO_FRAG;
    ...
    public void onResume() {
        ...
        if (SHOW_MINI_PLAYER)
        {
            if (PATH_TO_FRAG != null)
            {
                ...
                {
                    Glide.with(getContext()).load(R.drawable.bewedoc).into(albumArt);
                }
